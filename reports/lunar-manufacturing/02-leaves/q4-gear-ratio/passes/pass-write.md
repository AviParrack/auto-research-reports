...
The threshold for absolute advantage at GTO under Metzger's mid-range parameters [metzger-2023] is approximately φ = 35. This is the most-cited figure in the public conversation, and it deserves to be carried with two caveats: it is contingent on Metzger's specific cost model, and it applies to GTO not LEO.
